Applied AI Candidate Take-Home: Store Assistant 
...
Use an LLM framework such as LangChain, LlamaIndex, PydanticAI, Agnos, etc. Use any database (any form of SQL or a json/csv file is acceptable). 
Use a tracing method for LLM calls that allows inspection of past conversations. Implement at least two tests. 
